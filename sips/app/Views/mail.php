...
<body width="100%" style="margin: 0; padding: 0 !important; /*mso-line-height-rule: exactly;*/ background-color: #ffffff;">
    ...
    <![endif]-->
        ...
        Terima kasih telah melakukan pendaftaran. Silakan verifikasi tokenmu agar bisa masuk ke web SIPS.
        </div>
	                            ...
	                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
	                                <tr>
	                                    <td dir="ltr" valign="top" style="padding: 0 10px;">
	                                        <img src="http://localhost:8080/tek.png" width="170" height="170" alt="alt_text" border="0" class="center-on-narrow" style="height: auto; background: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
	                                    </td>
	                                </tr>
	                            </table>
	                        </td>
	                            ...
	                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
	                                <tr>
	                                    <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px; text-align: left;" class="center-on-narrow">
	                                        ...
	                                        <p style="margin: 0 0 10px 0; text-align: justify">Terima kasih telah melakukan pendaftaran.<br>Silakan verifikasi akunmu agar bisa mengakses web SIPS ya!<br>Klik tombol verifikasi dibawah ini</p>
	                                        <!-- Button : BEGIN -->
	                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="float:left;">
	                                            <tr>
                                                    <td style="border-radius: 4px; background: #222222;">
														<span style="background: #181818; border: 1px solid #7a75b5; font-family: sans-serif; font-size: 25px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;"><b><a href="/verifikasi/1/2" style="color: white;">Verifikasi</a></b></span>
													</td>
	                                          </tr>
	                                      </table>
	                                      <!-- Button : END -->
